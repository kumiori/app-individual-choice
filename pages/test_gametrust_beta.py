...
def main():
    ...
    """
It's interesting because it involves sequential decision-making, where one player's decision influences the other's subsequent decision. 

Trusting behavior often depends on many factors and it is difficult to estimate. 

Transparency, clarity, how many other factors? This game allows us, researchers and players, to study how these factors influence decision-making and how trust and cooperation can emerge or break down in different situations.
And, more importantly, to foresee what are the outcomes.    
    ...
    st.write("Your task is to choose a level of trust between 0 and 1.")
    st.write("The bank has two choices: to repay the investor's trust (allocating a small part of its financial assets to the investor), or betray the investor refusing the allocation.")
    # st.write("Will the Trustee accept the challenge and move, or will it betray the investor's trust, business as usual?")
    st.write("Based on the investor's perceptions and the bank's response, both players will receive certain payoffs.")
    st.write("Remember, your level of trust can change: this is of utmost importance.")
